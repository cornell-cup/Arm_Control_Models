###########################################################################
## Makefile generated for Simulink model 'Arduino_Blinking_LED'. 
## 
## Makefile     : Arduino_Blinking_LED.mk
## Generated on : Sat Mar 16 12:35:47 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Arduino_Blinking_LED.elf
...
PRODUCT_NAME              = Arduino_Blinking_LED
MAKEFILE                  = Arduino_Blinking_LED.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/nh13m/Documents/Education/CornellCup/Models/Runnable_Simulink_Models
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Arduino_Blinking_LED_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Arduino_Blinking_LED.elf
...
DEFINES_ = -DMODEL=Arduino_Blinking_LED -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=8 -DMW_TIMERCOUNT=65534 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Arduino_Blinking_LED -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Arduino_Blinking_LED_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/Arduino_Blinking_LED_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Arduino_Blinking_LED_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
